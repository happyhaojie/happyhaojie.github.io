...
- **Wen, H.#**, Wang, K.#, Li, Y., Chen, H., Bao, P.*, Bi, Y.* (Submitted). *When Vision Learns to Speak: Language-Linked Modulation Diverges Between Human and Macaque Visual Cortex.*
- Fan, Z.#, **Wen, H.#**, Han, Z., Wang, X., Bi, Y. (Submitted). *Causal evidence for a shared mechanism linking language and tool use via the putamen.*
