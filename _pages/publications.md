...
{% include base_path %}
You can find my articles on my [Google Scholar](https://scholar.google.com/citations?user=jgwxm8EAAAAJ&hl=zh-CN&oi=ao).

## Publications and Manuscripts

### First / Co-first Author

- **Wen, H.#**, Wang, K.#, Li, Y., Chen, H., Bao, P.*, Bi, Y.* (Under Review). *When Vision Learns to Speak: Language-Linked Modulation Diverges Between Human and Macaque Visual Cortex.*
- Fan, Z.#, **Wen, H.#**, Han, Z., Wang, X., Bi, Y. (Under Review). *Causal evidence for a shared mechanism linking language and tool use via the putamen.*
